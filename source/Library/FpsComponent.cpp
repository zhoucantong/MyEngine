...
namespace Library
{
	...
	void FpsComponent::Initialize()
	{
		...
		// 	mSpriteFont = new SpriteFont(mGame->Direct3DDevice(),L"E:\\CPP\\MyEngine\\MyEngine\\content\\Fonts\\Arial_14_Regular.spritefont");
	}
	...
	void FpsComponent::SetPrintText(const std::string& strContent)
	{
		mstrPrintText = strContent;
	}
	void FpsComponent::Draw(const GameTime& gameTime)
	{
		...
		fpsLabel << std::setprecision(4) << L"Frame Rate: " <<
			mFrameRate << " Total Elapsed Time: " << gameTime.TotalGameTime()<<"Camera Position:"<< mstrPrintText.c_str();
